...
export const ja: Catalog = {
  ...
  'settings.history.search': 'パスを検索…',
  'settings.history.noMatch': '一致するプロジェクトはありません。',
  'settings.history.total': '全 {count} 件',
  'settings.history.prevPage': '前のページ',
  'settings.history.nextPage': '次のページ',
  'settings.history.selectAll': 'すべて選択',
  'settings.history.deleteSelected': '記録を削除 ({count})',
  'settings.history.deleteTitle': '選択したプロジェクトの記録を削除しますか?',
  'settings.history.deleteBody':
    '会話記録 {count} 件をゴミ箱に移します。プロジェクトフォルダとその中のファイルは削除しません。\n\n{list}',
  'settings.history.deleteConfirm': 'ゴミ箱に移す',
  'settings.history.deleteDone': '記録 {count} 件をゴミ箱に移しました。',
  'settings.history.deleteBusy': '{name} が実行中のため {count} 件をスキップしました。',
  'settings.history.deleteFailed': '{count} 件は削除できませんでした。',
  ...
  'shortcut.run.rerun': '選択中の実行を再実行',
  'shortcut.run.selectConfig': '実行構成を選択',
  ...
  'run.action.run': '実行',
  'run.action.stop': '停止',
  'run.action.rerun': '再実行',
  'run.action.restart': '再起動',
  ...
  // main/run/prepare.ts resolveRunCwd (run.start) and ipc.ts assertConfigCwd (run.saveConfigs) — thrown in main, shown verbatim in a renderer toast
  ...
  'run.start.cycle': '実行構成が互いを待機しています: {path}',
  'run.start.missingTask': '{name} が参照している実行構成がありません',
  'run.start.compoundNotRunnable': '複合構成はここでは実行できません — コマンドが 1 つ必要です',
  'run.start.stepFailed': '{name} を開始できませんでした: {detail}',
  'run.explorer.runFile': '{name} を実行',
  'run.runFile.notRunnable': '{name} は実行できるファイルではありません',
  'run.runFile.refused': '{name} を実行構成として保存できませんでした: {detail}',
  ...
  'run.manager.search': '構成を検索',
  'run.manager.apply': '適用',
  'run.manager.ok': 'OK',
  'run.manager.discardTitle': '変更を破棄しますか?',
  'run.manager.discardBody': '適用していない編集があります。破棄すると元に戻せません。',
  'run.manager.discard': '破棄',
  'run.manager.keepEditing': '編集を続ける',
  'run.manager.markDirty': 'まだ適用されていません',
  'run.manager.markIncomplete': '必須項目が空のため実行できません',
  'run.manager.markBrokenRef': '参照先の構成がないため実行できません',
  'run.manager.markTemporary': '一時的な構成 — 編集すると保存されます',
  'run.manager.newFolder': '新しいフォルダーへ',
  'run.manager.moveUp': '上へ',
  'run.manager.moveDown': '下へ',
  'run.manager.folderNameDefault': '新しいフォルダー',
  'run.manager.renameFolder': 'フォルダー名を変更',
  'run.manager.reason.INVALID_CONFIG': '{name}: 保存できない構成です',
  'run.manager.reason.UNSAFE_VALUE': '{name}: コマンドに入る値に Windows シェルが解釈する文字(& | ^ % ! < >)があります',
  'run.manager.reason.INVALID_CWD': '{name}: 作業フォルダーはプロジェクト内である必要があります',
  'run.manager.reason.INVALID_PREVIEW_URL': '{name}: プレビュー URL は http:// または https:// で始まるアドレスにしてください',
  ...
  'run.field.env': '環境変数',
  'run.field.members': 'メンバー',
  'run.env.key': 'キー',
  'run.env.value': '値',
  'run.env.addRow': '行を追加',
  'run.env.removeRow': '行を削除',
  'run.env.issue.emptyKey': 'キーが空のため、この行は保存されません',
  'run.env.issue.shadowed': '下の同じキーがこの値を上書きします',
  'run.field.allowMultipleInstances': '複数インスタンスを許可',
  'run.field.previewUrl': 'プレビュー URL',
  ...
  'run.section.configuration': '構成',
  'run.section.environment': '環境',
  'run.section.beforeLaunch': '起動前',
  'run.ref.add': '追加',
  'run.ref.remove': 'リストから削除',
  'run.ref.none': '追加できる構成がありません',
  'run.menu.recent': '最近',
  'run.menu.detected': '検出',
  'run.menu.temporary': '一時',
  'run.menu.running': '{count} 件実行中',
  'run.menu.edit': '{name} を編集…',
  'run.picker.search': '検索…',
  'run.picker.detected': 'このプロジェクトで検出',
  'run.picker.other': 'その他',
  'run.form.addOption': 'オプションを追加',
  'run.panel.tab': '実行',
  'run.panel.empty': 'まだ実行がありません — ツールバーの ▶ で開始してください',
  'run.panel.exitCode': '終了 {code}',
  'run.panel.stopping': '停止中…',
  'run.panel.close': '実行を閉じる',
  'run.panel.clear': '消去',
  ...
  'preview.toolbar.forward': '進む',
  'preview.toolbar.reload': '再読み込み',
  'preview.toolbar.stop': '停止',
  ...
  'preview.viewport.fill': 'パネルの大きさ',
  'preview.viewport.mobileS': 'モバイル S',
  'preview.viewport.mobileM': 'モバイル M',
  'preview.viewport.mobileL': 'モバイル L',
  'preview.viewport.tablet': 'タブレット',
  'preview.viewport.laptop': 'ノート PC',
  'preview.viewport.laptopL': 'ノート PC L',
  'preview.viewport.desktop': 'デスクトップ',
  'preview.viewport.rotate': '縦横を切り替え',
  'preview.menu.copyAddress': 'アドレスをコピー',
  'preview.menu.inspect': '要素を検証',
  'preview.waiting': 'サーバーを待っています…',
  'preview.error.unreachable': '{host} が応答しません',
  'preview.error.failed': 'ページを読み込めません: {detail}',
  'preview.error.crashed': 'ページが応答を停止しました',
  'preview.error.retry': '再試行',
  'preview.design.toggle': 'Design Mode',
  'preview.design.tray.title': 'メモ {count}',
  'preview.design.send': 'セッションに送る',
  'preview.design.copy': 'コピー',
  'preview.design.clear': 'すべて消す',
  'preview.design.delete': 'このメモを削除',
  'preview.design.comment': '何を変えますか？',
  'preview.design.intent.fix': '直してほしい',
  'preview.design.intent.change': '変えてほしい',
  'preview.design.intent.question': '質問',
  'preview.design.intent.approve': '良い',
  'preview.design.intent.label': '意図',
  'preview.design.limit': 'メモはタブごとに {max} 件までです',
  'preview.design.noSession': 'このプロジェクトに開いているセッションがありません',
  'preview.design.sent': '{name} に送信しました',
  'preview.design.sendWaiting': '{name} が入力を待っているため送信しませんでした。答えてから送り直してください',
  ...
  'jobs.run.resume': '再開',
  'jobs.run.coordinatorRestart': 'コーディネーターを再起動',
  'jobs.run.coordinatorRestartHint': 'このジョブを管理するコーディネーターセッションがありません — クリックで再起動します',
  'jobs.run.coordinatorRestartFailed': 'コーディネーターを再起動できませんでした',
  'jobs.run.resumeHint': '次の予約時刻から再び実行されます',
  ...
  'jobs.run.merged': 'ワークツリー {count} 個をプロジェクトフォルダーにマージしました',
  ...
  'jobs.new.coordinatorPick': 'アカウントを選んでください',
  'jobs.new.coordinatorHint': 'このジョブを管理するエージェントセッションのアカウントです。',
  ...
  'jobs.task.accountPick': 'アカウントを選んでください',
  'jobs.task.accountNone': '使用しない',
  'jobs.task.accountEmpty': '登録済みのアカウントがありません — 設定 → アカウントで先に追加してください',
