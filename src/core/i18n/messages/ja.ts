...
export const ja: Catalog = {
  ...
  'hiw.reanalyze': '再分析',
  'hiw.summary': '{count} 個の機能',
  'hiw.summary.attention': '{count} 件が要確認',
  'hiw.summary.analyzed': '{date} に分析',
  'hiw.feature.evidence': '根拠 {count}',
  'hiw.feature.review': '更新を確認',
  'hiw.feature.regenerate': '作り直す',
  'hiw.status.upToDate': '最新',
  'hiw.status.needsReview': '要確認',
  'hiw.status.possiblyStale': '古い可能性があります',
  'hiw.status.generating': '作成中',
  'hiw.status.updateAvailable': '更新あり',
  'hiw.status.generationFailed': '作成できませんでした',
  'hiw.recent.project': '最近の変更 · プロジェクト全体',
  'hiw.pane.overview': '何をしますか',
  'hiw.pane.flow': 'どう動きますか',
  'hiw.pane.flowHint': 'ステップをクリックすると右側がそのステップに絞り込まれます',
  'hiw.pane.failures': '何が失敗しますか',
  'hiw.pane.decisions': 'なぜこうなっていますか',
  'hiw.pane.implementation': '実装',
  'hiw.pane.changes': '最近の変更',
  'hiw.pane.evidence': '根拠 {count}',
  'hiw.pane.edit': '編集',
  'hiw.pane.regenerate': '作り直す',
  'hiw.pane.reference': '参照',
  'hiw.scope.clear': 'すべて表示',
  'hiw.scope.whatHappens': 'このステップで起きること',
  'hiw.scope.why': 'なぜ',
  'hiw.scope.implementation': 'このステップの実装',
  'hiw.scope.changes': 'このステップを変えた変更',
  'hiw.empty.body': 'このプロジェクトが何をし、どう動くのかを、現在のコードとセッション · Job · 決定の記録からまとめます。',
