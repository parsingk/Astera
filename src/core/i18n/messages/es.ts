...
export const es: Catalog = {
  ...
  'run.action.rerun': 'Volver a ejecutar',
  'run.action.restart': 'Reiniciar',
  ...
  'run.panel.tab': 'Ejecución',
  'run.panel.empty': 'Aún no hay ejecuciones — pulsa ▶ en la barra de herramientas para iniciar una',
  'run.panel.exitCode': 'salida {code}',
  'run.panel.stopping': 'Deteniendo…',
  ...
  'jobs.run.coordinatorRestart': 'Reiniciar el coordinador',
  'jobs.run.coordinatorRestartHint': 'Ninguna sesión de coordinador gestiona este trabajo: haz clic para iniciar otra',
  'jobs.run.coordinatorRestartFailed': 'No se pudo reiniciar el coordinador',
  'jobs.run.resumeHint': 'Vuelve a ejecutarse desde la próxima hora programada',
  'jobs.run.startHint': 'Púlsalo cuando las Task estén listas y este trabajo empezará',
  'jobs.run.startFailed': 'No se pudo iniciar el trabajo',
  ...
  'jobs.run.merged': 'Se fusionaron {count} árbol(es) de trabajo en la carpeta del proyecto',
  'jobs.run.mergeConfirmTitle': 'Fusionar en la carpeta del proyecto',
  ...
  'jobs.run.deleteMerge': 'Fusionar en la carpeta del proyecto',
  'jobs.run.deleteMergeHint': 'Incorpora ahora lo que los trabajadores dejaron commiteado en sus worktrees ({count})',
  'jobs.run.deleteHide': 'Ocultar de la lista de historial',
  'jobs.run.deleteWorktrees': 'Eliminar las carpetas de worktree ({count})',
  'jobs.run.deleteWorktreesHint': 'Eliminar sin fusionar se lleva también los commits no fusionados',
  ...
  'jobs.run.scheduleMore': 'Ver {count} más',
