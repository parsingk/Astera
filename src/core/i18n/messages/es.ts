...
export const es: Catalog = {
  ...
  'hiw.reanalyze': 'Volver a analizar',
  'hiw.summary': '{count} funciones',
  'hiw.summary.attention': '{count} por revisar',
  'hiw.summary.analyzed': 'analizado el {date}',
  'hiw.feature.evidence': '{count} fuentes',
  'hiw.feature.review': 'Revisar actualización',
  'hiw.feature.regenerate': 'Regenerar',
  'hiw.status.upToDate': 'Al día',
  'hiw.status.needsReview': 'Por revisar',
  'hiw.status.possiblyStale': 'Puede estar desactualizado',
  'hiw.status.generating': 'Generando',
  'hiw.status.updateAvailable': 'Actualización disponible',
  'hiw.status.generationFailed': 'No se pudo generar',
  'hiw.recent.project': 'Cambios recientes · todo el proyecto',
  'hiw.pane.overview': 'Qué hace',
  'hiw.pane.flow': 'Cómo funciona',
  'hiw.pane.flowHint': 'Haz clic en un paso para acotar la columna derecha a ese paso',
  'hiw.pane.failures': 'Qué puede fallar',
  'hiw.pane.decisions': 'Por qué funciona así',
  'hiw.pane.implementation': 'Implementación',
  'hiw.pane.changes': 'Cambios recientes',
  'hiw.pane.evidence': '{count} fuentes',
  'hiw.pane.edit': 'Editar',
  'hiw.pane.regenerate': 'Regenerar',
  ...
  'hiw.scope.changes': 'Cambios que tocaron este paso',
  'hiw.empty.body': 'Astera puede explicar qué hace este proyecto y cómo funciona, usando el código actual, las sesiones, los Jobs y las decisiones del proyecto.',
