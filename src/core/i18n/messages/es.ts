...
export const es: Catalog = {
  ...
  'shortcut.run.rerun': 'Volver a ejecutar la ejecución seleccionada',
  'shortcut.run.selectConfig': 'Seleccionar configuración de ejecución',
  ...
  'run.start.cycle': 'Estas configuraciones de ejecución se esperan entre sí: {path}',
  'run.start.missingTask': '{name} apunta a una configuración de ejecución que ya no existe',
  'run.start.compoundNotRunnable': 'Una configuración compuesta no se puede ejecutar aquí: se requiere un único comando',
  'run.start.stepFailed': 'No se pudo iniciar {name}: {detail}',
  'run.explorer.runFile': "Ejecutar '{name}'",
  'run.runFile.notRunnable': '{name} no es un archivo que esta aplicación sepa ejecutar',
  'run.runFile.refused': 'No se pudo guardar {name} como configuración de ejecución: {detail}',
  ...
  'run.manager.markBrokenRef': 'Apunta a una configuración que no está aquí; no puede ejecutarse',
  'run.manager.markTemporary': 'Temporal: al editarla se conserva',
  'run.manager.newFolder': 'Mover a una carpeta nueva',
  'run.manager.moveUp': 'Subir',
  'run.manager.moveDown': 'Bajar',
  'run.manager.folderNameDefault': 'Carpeta nueva',
  'run.manager.renameFolder': 'Cambiar el nombre de la carpeta',
  ...
  'run.manager.reason.INVALID_PREVIEW_URL': '{name}: la URL de vista previa debe empezar por http:// o https://',
  ...
  'run.field.previewUrl': 'URL de vista previa',
  ...
  'run.section.configuration': 'Configuración',
  'run.section.environment': 'Entorno',
  'run.section.beforeLaunch': 'Antes de iniciar',
  'run.ref.add': 'Añadir',
  'run.ref.remove': 'Quitar de la lista',
  'run.ref.none': 'No hay configuraciones que se puedan añadir',
  'run.menu.recent': 'Recientes',
  'run.menu.detected': 'detectada',
  'run.menu.temporary': 'temporal',
  'run.menu.running': '{count} en ejecución',
  'run.menu.edit': "Editar '{name}'…",
  ...
  'run.panel.openPreview': 'Abrir {url} en una vista previa',
  'run.panel.previewFound': '{url} está activo',
  'run.panel.previewOpen': 'Abrir una vista previa',
  ...
  'preview.toolbar.forward': 'Adelante',
  'preview.toolbar.reload': 'Recargar',
  'preview.toolbar.stop': 'Detener',
  ...
  'preview.viewport.fill': 'Tamaño del panel',
  'preview.viewport.mobileS': 'Móvil S',
  'preview.viewport.mobileM': 'Móvil M',
  'preview.viewport.mobileL': 'Móvil L',
  'preview.viewport.tablet': 'Tableta',
  'preview.viewport.laptop': 'Portátil',
  'preview.viewport.laptopL': 'Portátil L',
  'preview.viewport.desktop': 'Escritorio',
  'preview.viewport.rotate': 'Girar',
  'preview.menu.copyAddress': 'Copiar dirección',
  'preview.menu.inspect': 'Inspeccionar elemento',
  'preview.waiting': 'Esperando al servidor…',
  'preview.error.unreachable': '{host} no responde',
  'preview.error.failed': 'No se pudo cargar la página: {detail}',
  'preview.error.crashed': 'La página dejó de responder',
  'preview.error.retry': 'Reintentar',
  'preview.design.toggle': 'Design Mode',
  'preview.design.tray.title': '{count} notas',
  'preview.design.send': 'Enviar a la sesión',
  'preview.design.copy': 'Copiar',
  ...
  'preview.design.comment': '¿Qué debería cambiar?',
  ...
  'preview.design.sent': 'Enviado a {name}',
  'preview.design.sendWaiting': '{name} está esperando una respuesta; no se envió nada. Respóndela y vuelve a enviar',
  ...
  'preview.agent.running': 'La agente está manejando esta página',
  'preview.agent.stop': 'Detener el script de la agente',
  'preview.agent.stopped': 'Script de la agente detenido',
