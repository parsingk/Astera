...
export const en: Record<keyof typeof ko, string> = {
  ...
  'settings.cliMissing.title': 'Claude Code CLI not found',
  'settings.cliMissing.bodyPre': 'This app is a launcher that runs the installed',
  'settings.cliMissing.bodyPost': 'CLI. Install the CLI, then restart the app.',
  ...
  'update.info.available': 'Downloading new version {version}…',
  ...
  'session.new.codexMissingPost': 'Install it, then try again.',
