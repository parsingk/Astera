...
export const en: Record<keyof typeof ko, string> = {
  ...
  'firstRun.body': 'Both are the same session. Only the way you look at it differs, and you can change it in Settings, or from the top right of a session, at any time.',
