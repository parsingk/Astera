...
export const en: Record<keyof typeof ko, string> = {
  ...
  'settings.defaultKind.title': 'New sessions start as',
  'settings.defaultKind.terminal': 'Terminal',
  'settings.defaultKind.chat': 'Conversation',
  'settings.defaultKind.hint':
    'The new-session and resume dialogs open on this kind. Changing it in the dialog applies to that session only.',
  'settings.defaultKind.saveFailed': 'Could not save what new sessions start as: {detail}',
  ...
  'shortcut.run.rerun': 'Rerun the selected run',
  'shortcut.run.selectConfig': 'Select run configuration',
  ...
  'explorer.find.replacePlaceholder': 'Replace with',
  'explorer.find.count': '{n} / {total}',
  'explorer.find.countMany': '{total} matches',
  'explorer.find.noResults': 'No results',
  'explorer.find.badRegexp': 'Bad pattern',
  'explorer.find.prev': 'Previous match',
  'explorer.find.next': 'Next match',
  'explorer.find.selectAll': 'Select all matches',
  'explorer.find.close': 'Close find',
  'explorer.find.caseSensitive': 'Match case',
  'explorer.find.wholeWord': 'Whole word',
  'explorer.find.regexp': 'Regular expression',
  'explorer.find.replace': 'Replace',
  'explorer.find.replaceAll': 'Replace all',
  'explorer.find.showReplace': 'Show replace',
  'explorer.find.hideReplace': 'Hide replace',
  ...
  'account.usage.fiveHour': '5h',
  'account.usage.weekly': 'Weekly',
  'account.usage.resetsIn': 'in {d}',
  'account.usage.refreshedAgo': 'Updated {d} ago',
  ...
  'firstRun.title': 'What should new sessions be?',
  'firstRun.body': 'You can change this in Settings at any time, and pick the other one in the dialog that starts a session.',
  'firstRun.terminal': 'Terminal',
  'firstRun.terminalWhat': 'The CLI in a terminal',
  'firstRun.chat': 'Conversation',
  'firstRun.chatWhat': 'No terminal — just the exchange',
  ...
  'setup.codexWhat': "OpenAI's coding agent",
  'setup.source': 'Downloads and installs from {host}',
  'setup.install': 'Install',
  'setup.installing': 'Installing…',
  'setup.showCommand': 'Show command',
  ...
  'setup.unsupported': 'No installer is known for this system yet. Install it yourself, then restart the app.',
  ...
  'run.action.rerun': 'Rerun',
  'run.action.restart': 'Restart',
  ...
  'run.start.cycle': 'These run configurations wait on each other: {path}',
  'run.start.missingTask': '{name} points at a run configuration that no longer exists',
  'run.start.compoundNotRunnable': 'A compound configuration cannot run here — a single command is required',
  'run.start.stepFailed': 'Could not start {name}: {detail}',
  'run.explorer.runFile': "Run '{name}'",
  'run.runFile.notRunnable': '{name} is not a file this app knows how to run',
  'run.runFile.refused': '{name} could not be stored as a run configuration: {detail}',
  ...
  'run.manager.search': 'Search configurations',
  'run.manager.apply': 'Apply',
  'run.manager.ok': 'OK',
  'run.manager.discardTitle': 'Discard changes?',
  'run.manager.discardBody': 'You have edits that were not applied. Discarding cannot be undone.',
  'run.manager.discard': 'Discard',
  'run.manager.keepEditing': 'Keep editing',
  'run.manager.markDirty': 'Not applied yet',
  'run.manager.markIncomplete': 'A required field is empty; this configuration cannot run',
  'run.manager.markBrokenRef': 'This points at a configuration that is not here; it cannot run',
  'run.manager.markTemporary': 'Temporary — editing it makes it permanent',
  'run.manager.newFolder': 'Move to a new folder',
  'run.manager.moveUp': 'Move up',
  'run.manager.moveDown': 'Move down',
  'run.manager.folderNameDefault': 'New folder',
  'run.manager.renameFolder': 'Rename folder',
  'run.manager.reason.INVALID_CONFIG': '{name}: this configuration cannot be stored',
  'run.manager.reason.UNSAFE_VALUE': '{name}: a value that reaches the command holds a character the Windows shell interprets (& | ^ % ! < >)',
  'run.manager.reason.INVALID_CWD': '{name}: the working directory must be inside the project',
  'run.manager.reason.INVALID_PREVIEW_URL': '{name}: the preview URL must be an http:// or https:// address',
  ...
  'run.field.members': 'Members',
  'run.env.key': 'Key',
  'run.env.value': 'Value',
  'run.env.addRow': 'Add row',
  'run.env.removeRow': 'Remove row',
  'run.env.issue.emptyKey': 'The key is empty, so this row is not saved',
  'run.env.issue.shadowed': 'A later row with the same key overrides this value',
  'run.field.allowMultipleInstances': 'Allow multiple instances',
  'run.field.previewUrl': 'Preview URL',
  ...
  'run.section.configuration': 'Configuration',
  'run.section.environment': 'Environment',
  'run.section.beforeLaunch': 'Before launch',
  'run.ref.add': 'Add',
  'run.ref.remove': 'Remove from the list',
  'run.ref.none': 'No configuration can be added',
  'run.menu.recent': 'Recent',
  'run.menu.detected': 'detected',
  'run.menu.temporary': 'temporary',
  'run.menu.running': '{count} running',
  'run.menu.edit': "Edit '{name}'…",
  'run.picker.search': 'Search…',
  'run.picker.detected': 'Detected in this project',
  'run.picker.other': 'Other',
  'run.form.addOption': 'Add option',
  'run.panel.tab': 'Run',
  'run.panel.empty': 'No runs yet — press ▶ in the toolbar to start one',
  'run.panel.exitCode': 'exit {code}',
  'run.panel.stopping': 'Stopping…',
  'run.panel.close': 'Close run',
  'run.panel.openPreview': 'Open {url} in a preview',
  'run.panel.previewFound': '{url} is up',
  'run.panel.previewOpen': 'Open a preview',
  ...
  'preview.toolbar.forward': 'Forward',
  'preview.toolbar.reload': 'Reload',
  'preview.toolbar.stop': 'Stop',
  ...
  'preview.viewport.fill': 'Pane size',
  'preview.viewport.mobileS': 'Mobile S',
  'preview.viewport.mobileM': 'Mobile M',
  'preview.viewport.mobileL': 'Mobile L',
  'preview.viewport.tablet': 'Tablet',
  'preview.viewport.laptop': 'Laptop',
  'preview.viewport.laptopL': 'Laptop L',
  'preview.viewport.desktop': 'Desktop',
  'preview.viewport.rotate': 'Rotate',
  'preview.menu.copyAddress': 'Copy address',
  'preview.menu.inspect': 'Inspect element',
  'preview.waiting': 'Waiting for the server…',
  'preview.error.unreachable': '{host} is not responding',
  'preview.error.failed': 'The page could not be loaded: {detail}',
  'preview.error.crashed': 'The page stopped responding',
  'preview.error.retry': 'Retry',
  'preview.design.toggle': 'Design Mode',
  'preview.design.tray.title': '{count} notes',
  'preview.design.send': 'Send to session',
  'preview.design.copy': 'Copy',
  ...
  'preview.design.comment': 'What should change?',
  ...
  'preview.design.sent': 'Sent to {name}',
  'preview.design.sendWaiting': '{name} is waiting on a prompt — nothing was sent. Answer it and send again',
  ...
  'jobs.run.deleteMerge': 'Merge into the project folder',
  'jobs.run.deleteMergeHint': 'Folds what the workers committed in their worktrees in now ({count} worktree(s))',
  'jobs.run.deleteHide': 'Hide from the history list',
  'jobs.run.deleteWorktrees': 'Delete the worktree folders ({count})',
  'jobs.run.deleteWorktreesHint': 'Deleting without merging takes the unmerged commits with it',
  'jobs.run.delete': 'Delete job',
  'jobs.run.deleteBody': 'Deleting "{objective}" — {tasks} Task(s) and {events} event(s) go with it, and it cannot be undone.\n\nWorktrees and branches that have not been merged yet are left alone (merged ones were already removed at merge time — what remains can be deleted from the worktree panel in the file explorer).',
  ...
  'jobs.run.scheduleMore': 'Show {count} more',
  ...
  'conversation.pending.trust': 'Directory trust check',
  'conversation.pending.trustBody': 'This directory has to be trusted before any work can start in it.',
  ...
  'conversation.pending.about': 'What is being asked',
  'conversation.ask.title': 'Claude has a question',
  'conversation.ask.other': 'Type your own',
  'conversation.ask.otherPlaceholder': 'Type here.',
  'conversation.ask.submit': 'Send answers',
  'conversation.ask.answering': 'Sending.',
  'conversation.ask.waiting': 'Waiting for the question to appear on the terminal.',
  'conversation.ask.terminal': 'This was started on the terminal. Finish it there.',
  'conversation.ask.stopped.dialog-gone': 'The question left the terminal screen, so nothing was sent.',
  'conversation.ask.stopped.not-pristine': 'This was started on the terminal. Finish it there.',
  'conversation.ask.stopped.no-change': 'The terminal did not react, so this stopped. Check it there.',
  'conversation.ask.stopped.stuck': 'The terminal moved in an unexpected way, so this stopped. Check it there.',
  'conversation.ask.stopped.review-mismatch': 'The terminal review did not match what was chosen, so nothing was sent. Check it there.',
