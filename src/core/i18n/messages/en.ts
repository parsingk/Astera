...
export const en: Record<keyof typeof ko, string> = {
  ...
  'hiw.reanalyze': 'Re-analyze',
  'hiw.summary': '{count} features',
  'hiw.summary.attention': '{count} need review',
  'hiw.summary.analyzed': 'analyzed {date}',
  'hiw.feature.evidence': '{count} sources',
  'hiw.feature.review': 'Review update',
  'hiw.feature.regenerate': 'Regenerate',
  'hiw.status.upToDate': 'Up to date',
  'hiw.status.needsReview': 'Needs review',
  'hiw.status.possiblyStale': 'Possibly outdated',
  'hiw.status.generating': 'Generating',
  'hiw.status.updateAvailable': 'Update available',
  'hiw.status.generationFailed': "Couldn't generate",
  'hiw.recent.project': 'Recent changes · whole project',
  'hiw.pane.overview': 'What it does',
  'hiw.pane.flow': 'How it works',
  'hiw.pane.flowHint': 'Click a step to narrow the right column to it',
  'hiw.pane.failures': 'What can go wrong',
  'hiw.pane.decisions': 'Why it works this way',
  'hiw.pane.implementation': 'Implementation',
  'hiw.pane.changes': 'Recent changes',
  'hiw.pane.evidence': '{count} sources',
  'hiw.pane.edit': 'Edit',
  'hiw.pane.regenerate': 'Regenerate',
  ...
  'hiw.scope.changes': 'Changes that touched this step',
  'hiw.empty.body': 'Astera can explain what this project does and how it works, using the current code, sessions, Jobs and project decisions.',
  ...
  'hiw.analyze.running': 'Analyzing…',
  'hiw.analyze.done': 'Found {count} features.',
  'hiw.analyze.noAccount': 'Pick an explanation account in settings first.',
  'hiw.analyze.failed': "Couldn't analyze the project: {detail}",
