...
export const en: Record<keyof typeof ko, string> = {
  ...
  'run.manager.seedHint': 'Auto-detected configurations are read-only.',
  'run.type.shell': 'Shell command',
  'run.type.npm': 'npm script',
  'run.type.node': 'Node.js file',
  'run.type.gradle': 'Gradle task',
  'run.type.maven': 'Maven goal',
