...
export const ko = {
  ...
  'hiw.reanalyze': '다시 분석',
  'hiw.summary': '{count}개 기능',
  'hiw.summary.attention': '{count}개 검토 필요',
  'hiw.summary.analyzed': '{date} 분석',
  'hiw.feature.evidence': '근거 {count}',
  'hiw.feature.review': '갱신 검토',
  'hiw.feature.regenerate': '다시 만들기',
  'hiw.status.upToDate': '최신',
  'hiw.status.needsReview': '검토 필요',
  'hiw.status.possiblyStale': '오래됐을 수 있음',
  'hiw.status.generating': '만드는 중',
  'hiw.status.updateAvailable': '갱신 있음',
  'hiw.status.generationFailed': '만들지 못했습니다',
  'hiw.recent.project': '최근 변경 · 프로젝트 전체',
  'hiw.pane.overview': '무엇을 하나요',
  'hiw.pane.flow': '어떻게 동작하나요',
  'hiw.pane.flowHint': '단계를 클릭하면 오른쪽이 그 단계로 좁혀집니다',
  'hiw.pane.failures': '무엇이 잘못될 수 있나요',
  'hiw.pane.decisions': '왜 이렇게 만들었나요',
  'hiw.pane.implementation': '실제 구현은',
  'hiw.pane.changes': '최근 변경',
  'hiw.pane.evidence': '근거 {count}',
  'hiw.pane.edit': '편집',
  'hiw.pane.regenerate': '다시 만들기',
  'hiw.pane.reference': '참조',
  'hiw.scope.clear': '전체 보기',
  'hiw.scope.whatHappens': '이 단계에서 일어나는 일',
  'hiw.scope.why': '왜',
  'hiw.scope.implementation': '이 단계의 구현',
  'hiw.scope.changes': '이 단계를 바꾼 변경',
  'hiw.empty.body': '이 프로젝트가 무엇을 하고 어떻게 동작하는지 지금 코드와 세션·Job·결정 기록으로 정리합니다.',
