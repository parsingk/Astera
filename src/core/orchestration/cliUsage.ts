...
export const USAGE: Record<PublicCommand, CommandUsage> = {
  ...
  'jobs-wait': {
    ...
    detail:
      'Four endings, and the exit code says which: finished well (0), a question is open, the run is paused or every worker is waiting for a usage limit to reset (8, `details` says which), the run failed (10), the deadline passed (7).',
