...
describe('hostFeatures (R17)', () => {
  it('announces spawn, worktrees, dispatch and rolling together, or none of them', () => {
    expect(hostFeatures({ spawns: true })).toEqual([HOST_FEATURE_SPAWN, HOST_FEATURE_WORKTREES, HOST_FEATURE_DISPATCH, HOST_FEATURE_ROLLING])
