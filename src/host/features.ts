...
export function hostFeatures(a: { spawns: boolean }): string[] {
  const spawning = a.spawns ? [HOST_FEATURE_SPAWN, HOST_FEATURE_WORKTREES, HOST_FEATURE_DISPATCH, HOST_FEATURE_ROLLING, HOST_FEATURE_BLOCKS, HOST_FEATURE_ROLL_JOURNAL] : []
